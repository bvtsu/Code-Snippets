...
# This script submits jobs to the cluster to run an sbatch containing motif_search.py on each input line from PLANFILE
#Note, there must be a newline at the end for this to read each line
