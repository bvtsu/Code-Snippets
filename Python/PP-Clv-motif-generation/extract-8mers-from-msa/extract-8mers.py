...
with open("outputs/8mer.fasta", "w") as output_file: #create a new fasta file in the outputs folder
    for key,value in separated_cleavage_dict_noblanks_x_nodupes.items(): #iterate through each of the dicts
